...
- [Jarmos-san/resume-template](https://github.com/Jarmos-san/resume-template) ([v1.0.0](https://github.com/Jarmos-san/resume-template/releases/tag/v1.0.0), 4 days ago) - A resume template built with Typst and meant for technical roles.
